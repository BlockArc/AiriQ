...
export default function FlipCard({
  ...
  return (
    <div
      className={cn("relative h-72 w-56 [perspective:1000px]", className)}
      {...props}
    ...
    >
      <div
        className={cn(
          ...
          isFlipped ? rotationClass[rotate] : ""
        )}
      >
        {/* Front */}
        ...
        <div
          className={cn(
            "absolute h-full w-full rounded-2xl bg-black/80 p-4 text-slate-200 [backface-visibility:hidden] [transform:rotateY(180deg)]"
          )}
        >
