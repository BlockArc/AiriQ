...
export const Feedback = () => {
  ...
  return (
    ...
    className={twMerge(
      'fixed bottom-6 left-1/2 -translate-x-1/2 w-fit overflow-hidden border py-2 shadow-sm dark:border-neutral-800 dark:bg-neutral-950'
    )}
  >
      <span className="flex items-center justify-center  gap-3 pl-4 pr-2">
        <div className="text-sm text-black dark:text-neutral-400">Leave a feedback </div>
